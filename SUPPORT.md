...
| Press inquiry | Email `press@lictor.ai` (live by Sep 2026) |
| Compliance / vendor risk questionnaire | Email `compliance@lictor.ai` |
...
| `lictor.ai/teardowns` | Tuesdays | Weekly audit teardown of a real vibe-coded app |
| `lictor.ai/changelog` | Per release | What shipped in each version |
