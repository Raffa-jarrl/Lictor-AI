...
8/ Lictor's audit catches this pattern. Free, local, no signup. lictor.ai/skill

Full FindMeMail writeup with the actual SQL fix: lictor.ai/teardowns/findmemail
