...
# Expanded 2026-05-21 from 18 vendors → 43 vendors after splunk-production critical find
VENDOR_TYPOS = {
    # Original 18 (kept)
    ...
    "elasticsearch": ["elastcsearch", "elasticserch", "elastiserch", "esearch", "elasticseach"],
    "postgres":  ["postgress", "postres", "postrges", "potgres", "pgsql", "psql"],
    ...
    # New 25 added 2026-05-21 expansion
    "kafka":     ["kakfa", "kfka", "kafa", "kaffka"],
    "hadoop":    ["hadop", "hadoopp", "hadoo", "hadoof"],
    "spark":     ["sprk", "sparcc", "spakr"],
    "snowflake": ["snowfake", "snwflake", "snowflk", "snowfaker"],
    "databricks":["databriks", "databrcks", "datbricks", "databriks"],
    "tableau":   ["tablau", "tableu", "tableu", "tableo"],
    "looker":    ["lookr", "looer", "lookerr"],
    "dbt":       ["dbtt", "dbtcloud", "dbtcore"],
    "airflow":   ["airflw", "airflo", "airflow", "arflow"],
    "salesforce":["salseforce", "salesforse", "salesfoce", "salesforece", "sfdc"],
    "oracle":    ["oracl", "oarcle", "ocrale", "orcl"],
    "ibm":       ["ibm-data", "ibm-prod", "ibm-cloud", "iibm"],
    "sap":       ["sapdata", "saperp", "sapprod"],
    "vmware":    ["vmwre", "vmware", "vmwere", "vware"],
    "cisco":     ["csico", "ciscoo", "cisko", "cico"],
    "juniper":   ["junpier", "juniprr", "junipr"],
    "fortinet":  ["fortnet", "fortinet", "fortinte", "fortinte"],
    "paloalto":  ["paloato", "paloalto", "palaoto", "paloato"],
    "cyberark":  ["cybark", "cyberark", "cybarkark", "cyperark"],
    "sentinelone":["sentnelone", "sentinelones", "sentinone"],
    "wiz":       ["wiz-data", "wiz-prod", "wizcloud"],
    "snyk":      ["snyk-data", "snyk-prod", "snk", "snykcloud"],
    "datadog":   ["datdog", "datadogg", "datadg", "datadogcloud"],
    "okta":      ["okta-data", "okta-prod", "okta-dev", "okta-staging", "oktaa", "ocata"],
    "auth0":     ["auth00", "athu0", "auth-zero", "authzero"],
    "hashicorp": ["hasicorp", "hashcorp", "hashicrp"],
    "terraform": ["teraform", "terraform", "terrafrm", "terraforme"],
    "consul":    ["counsul", "concul", "consl"],
    "vault":     ["valt", "vaullt", "vaultcloud"],
    "nomad":     ["nomd", "nommad", "nomadcloud"],
    "twilio":    ["twillio", "twlio", "twilo", "twillo"],
    "sendgrid":  ["sengrid", "sendgrd", "sendgrd"],
