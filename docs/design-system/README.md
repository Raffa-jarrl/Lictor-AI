...
- Eventually: the dashboard at `lictor.ai/transparency`
...
3. **MetricTile** — stat-card variant for the upcoming `lictor.ai/transparency` page. Differs from `.waitlist-stat` by adding a delta-vs-last-period footer.
