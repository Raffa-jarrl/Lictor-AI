...
- Total candidate files inspected: **120**
- Files with a confirmed `service_role` JWT decoded: **3**
- Of those, in client-likely paths (the actual bug): **3**
