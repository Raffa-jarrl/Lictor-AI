...
- Total candidate files inspected: **54**
- Files with a confirmed `service_role` JWT decoded: **1**
- Of those, in client-likely paths (the actual bug): **1**
