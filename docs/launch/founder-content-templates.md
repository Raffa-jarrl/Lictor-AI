# Founder content templates — Raffa's video kit

> **Generated:** 2026-05-15
> **Target audience:** Raffa — recording founder content for Lictor's content engine
> **The thesis:** Snyk has no face. Lictor has Raffa. Weekly founder content is the moat Snyk's PR team literally cannot copy. But the kit has to make recording *easy*, not aspirational. This is the kit.

---

## The three formats Raffa will rotate
...
If Raffa doesn't already have these, the kit is ~$200 one-time:
...
1. **"Hi, I'm Raffa. This is Lictor."** (3–5 min — short long-form intro)
