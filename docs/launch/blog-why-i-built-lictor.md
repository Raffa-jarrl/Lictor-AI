...
**Solo-founder means slow.** I can ship two patterns a month, maybe three. A team of four could ship eight. The bet is that the patterns matter more than the speed. The other bet is that the AI crew compounds — Wolf plans, Hawk audits, Lyrebird writes, Owl filters, Mantis reviews. Each of those is a person's worth of work that I don't have to do every week. The crew is the multiplier. We'll see how far that gets us.
...
- Five Fortune 500 CISOs Raffa has consulted for in the last three years — short email, just the link, no ask. They are not the buyer, but they are the network. Multiple of them will forward it to junior security engineers who are the buyer.
...
Tone check: smart-friend email, not press release. Casual but precise. Raffa sounds like a person who'd help you on a Saturday, not someone reading bullet points off a deck. The closing invitation is real — file an issue, push back on the voice, find a finding Lictor missed. Not a CTA. An invitation.

Voice match against `docs/launch/founder-content-templates.md`: confirmed. Same Raffa voice as the video kit. Same "20 years in cybersec, now I do this in my garage" credibility shape. The opener (a specific Saturday-morning phone call) follows the "named consequence" opener pattern from the template's opener library.
