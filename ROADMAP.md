...
| **Jun 22 (W25)** | Audit corpus (KV append-only) + `lictor-ai.com/in-the-wild` internal-only aggregate dashboard | First aggregate stats published internally | Corpus stores any URL or PII | dev + Conductor |
...
| **Jul 6 (W27)** | **`lictor-ai.com/scan/<url>` PUBLIC** — paste-a-URL form + embeddable badge | 100 user-initiated scans in week 1 | <10 | dev + Quill (launch copy) |
